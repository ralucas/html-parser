...
var parseContext = function(raw, options) {
  var index = 0;
  var context = {
    text: '',
    peek: function(count) {
 ...
 */
HTMlParser.prototype.parse = function(htmlString, callbacks) {
 ...
 */
HTMlParser.prototype.sanitize = function(htmlString, removalCallbacks) {
  ...
  this.parse(htmlString, callbacks);
  return sanitized;
};
